...
let StringManipulationComponent = class StringManipulationComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let PipesRoutingModule = class PipesRoutingModule {
};
...
const routes = [
    ...
    { path: 'apps', loadChildren: () => Promise.resolve(/*! import() */).then(__webpack_require__.bind(null, /*! ./modules/apps/apps.module */ "./src/app/modules/apps/apps.module.ts")).then(m => m.AppsModule) },
    { path: 'pipes', loadChildren: () => Promise.resolve(/*! import() */).then(__webpack_require__.bind(null, /*! ./modules/pipes/pipes.module */ "./src/app/modules/pipes/pipes.module.ts")).then(m => m.PipesModule) },
];
